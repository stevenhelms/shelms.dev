    ...
    <section id="two" className="wrapper alt style2">
      ...
      <section className="spotlight">
        ...
        <div className="content">
          ...
          <p>
            My own love of food lead me to being overweight, weighing in at 240lbs. I've been on a
            long journey to master that relationship. I now weigh in around 145lbs and have learned
            to cook and eat healthy foods. I've learned that food is not only fuel for the body but
            builds relationships and creates memories with friends and families. I strive to help
            others see the health benefits of whole, minimally-processed foods so they can live a
            high quality life. I am now a classically trained chef and a nutrition coach.
          </p>
        </div>
      </section>
    </section>
